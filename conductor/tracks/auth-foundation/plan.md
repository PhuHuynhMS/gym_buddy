...
- [~] Task 4: Add protected route middleware and user profile API.
- [ ] Task 5: Build Flutter login and registration screens.
- [ ] Task 6: Connect Flutter auth forms to the backend API.
